...
ifeq ($(UNAME_S), Linux)
    ...
    LIB_PATH := $(JSON_FORTRAN_PREFIX)/lib #/opt/homebrew/Cellar/json-fortran/9.0.2/lib #$(JSON_FORTRAN_PREFIX)/lib
    BIN_PATH := $(JSON_FORTRAN_PREFIX)/bin #/opt/homebrew/Cellar/json-fortran/9.0.2/bin #$(JSON_FORTRAN_PREFIX)/bin
endif
